# -*- coding: utf-8 -*-
"""Text Generation Project.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1SPZjKEPr0kGXhI5JK7ZxjxD7IJs0elDf
"""
...
file=open("/content/drive/My Drive/Classroom/frankenstein-2.txt").read()

# tokenization 
# standardization
# what is tokenization? Tokenization is the process of breaking a stream of text up into word phrases symbols or other meaningful elements 
def tokenize_words(input):
      ...
      filtered = filter(lambda token: tokens not in  stopwords.words('english'),tokens)
      return  "".join(filtered)
#preprocess teh input data,make tokens 
...
# here we're going though the entire list of i/ps and converting the chars to numebers with a loop 
...
for i in range(0,input_len-seq_length,1):
    ...
    # converting list of characters to integers based on the previous values and appending teh values to our lists 
...
#saving the weights 
filepath='/content/drive/My Drive/Classroom/model_weights_saved.hdf5'
checkpoint=ModelCheckpoint(filepath,monitor='loss',verbose=1,save_best_only=True,mode='min')
desired_callbacks=[checkpoint]

#fit model and let it train
model.fit(X,y,epochs=1,batch_size=4,callbacks=desired_callbacks)

# recomple the model with the saved weights 
filename = "/content/drive/My Drive/Classroom/model_weights_saved.hdf5"
